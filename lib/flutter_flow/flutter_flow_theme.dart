...
abstract class FlutterFlowTheme {
  ...
  late Color palatinate;
  late Color lavenderFloral;
  late Color harvestGold;
  late Color silver;
  late Color zaffre;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xE8EEC060);
  late Color alternate = const Color(0xFFFFD700);
  late Color primaryText = const Color(0xFF252323);
  late Color secondaryText = const Color(0xFF424242);
  late Color primaryBackground = const Color(0xFFDD83AC);
  late Color secondaryBackground = const Color(0xFFFFFFF0);
  ...
  late Color palatinate = const Color(0xFF541848);
  late Color lavenderFloral = const Color(0xFFBA6EDB);
  late Color harvestGold = const Color(0xFFD69429);
  late Color silver = const Color(0xFFC8BEBE);
  late Color zaffre = const Color(0xFF361DA3);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF212121);
